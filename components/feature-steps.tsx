...
const features = [
	{
		...
		content:
			'Set up your brand identity with custom logos, descriptions, and contact information to create a lasting impression.',
	...
	},
	{
		...
		title: 'Go Public',
		content:
			'Launch your products to the world with a single click and start accepting orders from customers instantly.',
	...
	},
	{
		...
		title: 'Design & Layout',
		content:
			'Choose from premium themes and customize every detail to match your brand\'s unique aesthetic and style.',
	...
	},
	{
		...
		title: 'Custom Domain',
		content:
			'Connect your own custom domain to provide a professional and seamless shopping experience for your customers.',
				...
				<div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
					<div className="relative z-10">
						...
						<p className="font-geist text-foreground/60 mt-3">
							Everything you need to set up, customize, and launch your online
							presence with professional-grade tools.
						</p>
					</div>
					<div
